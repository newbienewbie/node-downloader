...
class Downloader extends EventEmitter{
    ...
    /**
     * 
     * @param {Array} arrayOfTask Task is Object like {url:'#',status:'',saveAs:''}
     * @param {Function} onTaskSucceeded=t=>{}
     * @param {onTaskFailed} onTaskFailed=t=>{}
     */
    downloadGroup(arrayOfTask=[{url:'#',status:'',saveAs:''}],onTaskSucceeded=t=>{},onTaskFailed=t=>{}){
